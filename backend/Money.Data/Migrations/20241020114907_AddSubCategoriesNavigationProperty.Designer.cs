...
namespace Money.Data.Migrations
{
    ...
    [Migration("20241020114907_AddSubCategoriesNavigationProperty")]
    partial class AddSubCategoriesNavigationProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Money.Data.Entities.DomainPayment", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id")
            ...
            modelBuilder.Entity("Money.Data.Entities.DomainUser", b =>
                {
                    ...
                    b.Property<int>("NextPaymentId")
                        .HasColumnType("integer")
                        .HasColumnName("next_payment_id");
            ...
            modelBuilder.Entity("Money.Data.Entities.DomainPayment", b =>
                {
                    b.HasOne("Money.Data.Entities.DomainUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_payments_domain_users_user_id");
