...
public partial class Home
{
    ...
    [
        new("1.3.16", new(2026, 5, 4), [
            new("Исправлено редактирование суммы с копейками в диалоге операции: при открытии существующей операции запятая в поле больше не пропадает и значение не схлопывается в целое число.", ChangeType.BugFix),
        ]),
